...
import html
import requests
import WolfXRobot.modules.sql.chatbot_sql as sql
...
from WolfXRobot.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "super saiyan Wolf Chatbot disable by {}.".format(mention_html(user.id, user.first_name)),
...
def kukiadd(update: Update, context: CallbackContext) -> str:
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "super saiyan Wolf Chatbot enable by {}.".format(mention_html(user.id, user.first_name)),
                parse_mode=ParseMode.HTML,
            )
